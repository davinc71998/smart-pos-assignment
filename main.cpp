...
int main()
{
	...
	int button,i,cnt,catecnt,target,check = 1,pass,selcate,selfood,selpur; // flag 및 버튼
	int sum=0, foodcnt,foodno,cash,cashsum=0; // 가격 정산
	int  no, price, category; //food 입력
	string menu, catename; // food 입력
